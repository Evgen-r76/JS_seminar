...
/*
//Вариант1
const positiveNum = +prompt("Введите положительное число");
const negativeNum = +prompt("Введите отрицательное число");
...
const positiveNum = +prompt("Введите положительное число");
const negativeNum = +prompt("Введите отрицательное число");
(positiveNum > 0 && negativeNum < 0) ? alert("Все значения верные") : alert("Одно или более значений некорректно.");
